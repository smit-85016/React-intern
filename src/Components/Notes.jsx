...
export default function Notes() {
  ...
  const removeAllNotes = async () => {
    ...
    // Update the notes state to be an empty array
    setMyNotes([]);
  };
    ...
    <>
      <div style={{ textAlign: 'center' }}>
        ...
        <button
          ...
          style={{ marginTop: '20px', backgroundColor: "e91e63", border: "#e91e63",borderradius: "9px", padding: "10px", margin: "10px", cursor: "pointer" }}
          onClick={write} 
        >
          Write
        </button>
        <button
          className='bg-blue-500 hover:bg-blue-600 text-white font-semibold py-2 px-4 rounded'
          style={{ marginTop: '20px', marginLeft: '5vw',  backgroundColor: "e91e63", border: "#e91e63",borderradius: "9px", padding: "10px", margin: "10px", cursor: "pointer" }}
          onClick={read}
        >
          Read
        </button>
